...
<html>
<head>
<title>权限管理系统b20130511 2231</title>
...
<body>
	...
	<div id="index_layout">
		...
		<div data-options="region:'center'" title="欢迎使用SyPro权限管理系统" style="overflow: hidden;">
		...
		<div data-options="region:'east',href:'${pageContext.request.contextPath}/layout/east.jsp'" title="当前时间" style="width: 200px; overflow: hidden;"></div>
